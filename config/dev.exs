...
config :cgenerator, SMGWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "xvkpRZz8AJydtNc0Tyys0s3kUzTyww1DjMsjDSHpNFT17bNBcRYXsQqDHmsahF6b",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:cgenerator, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:cgenerator, ~w(--watch)]}
  ]
...
config :cgenerator, SMGWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/cgenerator_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :cgenerator, dev_routes: true
